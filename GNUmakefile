...
install-local:
	...
	@mkdir -p ~/.terraform.d/plugins/local/bobhigs/auth0/$(VERSION)/$(GOOS)_$(GOARCH)/
	@mv terraform-provider-auth0 ~/.terraform.d/plugins/local/bobhigs/auth0/$(VERSION)/$(GOOS)_$(GOARCH)/terraform-provider-auth0_v$(VERSION)
